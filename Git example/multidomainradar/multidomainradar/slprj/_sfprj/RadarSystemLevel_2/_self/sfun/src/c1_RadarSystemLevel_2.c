...
#include "c1_RadarSystemLevel_2.h"
...
static void initialize_c1_RadarSystemLevel_2
  (SFc1_RadarSystemLevel_2InstanceStruct *chartInstance);
static void initialize_params_c1_RadarSystemLevel_2
  (SFc1_RadarSystemLevel_2InstanceStruct *chartInstance);
static void enable_c1_RadarSystemLevel_2(SFc1_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static void disable_c1_RadarSystemLevel_2(SFc1_RadarSystemLevel_2InstanceStruct *
  chartInstance);
static void c1_update_debugger_state_c1_RadarSystemLevel_2
  (SFc1_RadarSystemLevel_2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_RadarSystemLevel_2
  (SFc1_RadarSystemLevel_2InstanceStruct *chartInstance);
static void set_sim_state_c1_RadarSystemLevel_2
  (SFc1_RadarSystemLevel_2InstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_RadarSystemLevel_2(SFc1_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static void sf_c1_RadarSystemLevel_2(SFc1_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static void initSimStructsc1_RadarSystemLevel_2
  (SFc1_RadarSystemLevel_2InstanceStruct *chartInstance);
static void registerMessagesc1_RadarSystemLevel_2
  (SFc1_RadarSystemLevel_2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static creal_T c1_emlrt_marshallIn(SFc1_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c1_y, const char_T *c1_identifier);
static creal_T c1_b_emlrt_marshallIn(SFc1_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_RadarSystemLevel_2, const
  char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_RadarSystemLevel_2InstanceStruct
  *chartInstance);
  ...
  (SFc1_RadarSystemLevel_2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_RadarSystemLevel_2 = 0U;
}
  ...
  (SFc1_RadarSystemLevel_2InstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_RadarSystemLevel_2;
  ...
  (SFc1_RadarSystemLevel_2InstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_y = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
    "y");
  chartInstance->c1_is_active_c1_RadarSystemLevel_2 = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_RadarSystemLevel_2");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_RadarSystemLevel_2(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_RadarSystemLevel_2InstanceStruct *chartInstance;
  chartInstance = (SFc1_RadarSystemLevel_2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_RadarSystemLevel_2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_RadarSystemLevel_2), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_RadarSystemLevel_2);
  return c1_y;
}
...
void sf_c1_RadarSystemLevel_2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_RadarSystemLevel_2_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_RadarSystemLevel_2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_RadarSystemLevel_2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_RadarSystemLevel_2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_RadarSystemLevel_2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_RadarSystemLevel_2InstanceStruct *chartInstance;
    chartInstance = (SFc1_RadarSystemLevel_2InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_RadarSystemLevel_2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_RadarSystemLevel_2((SFc1_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
  initialize_c1_RadarSystemLevel_2((SFc1_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_RadarSystemLevel_2(void *chartInstanceVar)
{
  enable_c1_RadarSystemLevel_2((SFc1_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_RadarSystemLevel_2(void *chartInstanceVar)
{
  disable_c1_RadarSystemLevel_2((SFc1_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_RadarSystemLevel_2(void *chartInstanceVar)
{
  sf_c1_RadarSystemLevel_2((SFc1_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_RadarSystemLevel_2(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_RadarSystemLevel_2
    ((SFc1_RadarSystemLevel_2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_RadarSystemLevel_2();/* state var info */
...
extern void sf_internal_set_sim_state_c1_RadarSystemLevel_2(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_RadarSystemLevel_2((SFc1_RadarSystemLevel_2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_RadarSystemLevel_2(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_RadarSystemLevel_2(S);
}

static void sf_opaque_set_sim_state_c1_RadarSystemLevel_2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_RadarSystemLevel_2(S, st);
}

static void sf_opaque_terminate_c1_RadarSystemLevel_2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_RadarSystemLevel_2InstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c1_RadarSystemLevel_2((SFc1_RadarSystemLevel_2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_RadarSystemLevel_2((SFc1_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_RadarSystemLevel_2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_RadarSystemLevel_2
      ((SFc1_RadarSystemLevel_2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_RadarSystemLevel_2(SimStruct *S)
{
...
static void mdlRTW_c1_RadarSystemLevel_2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_RadarSystemLevel_2(SimStruct *S)
{
  SFc1_RadarSystemLevel_2InstanceStruct *chartInstance;
  chartInstance = (SFc1_RadarSystemLevel_2InstanceStruct *)utMalloc(sizeof
    (SFc1_RadarSystemLevel_2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_RadarSystemLevel_2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_RadarSystemLevel_2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_RadarSystemLevel_2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_RadarSystemLevel_2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_RadarSystemLevel_2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_RadarSystemLevel_2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_RadarSystemLevel_2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_RadarSystemLevel_2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_RadarSystemLevel_2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_RadarSystemLevel_2;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_RadarSystemLevel_2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_RadarSystemLevel_2;
...
void c1_RadarSystemLevel_2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_RadarSystemLevel_2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_RadarSystemLevel_2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_RadarSystemLevel_2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_RadarSystemLevel_2_method_dispatcher.\n"
