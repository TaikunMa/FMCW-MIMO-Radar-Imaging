...
#include <stddef.h>
#include "blas.h"
#include "RadarSystemLevel_2_sfun.h"
#include "c2_RadarSystemLevel_2.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "RadarSystemLevel_2_sfun_debug_macros.h"
...
static const char * c2_b_debug_family_names[3] = { "nargin", "nargout", "x" };

/* Function Declarations */
static void initialize_c2_RadarSystemLevel_2
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static void initialize_params_c2_RadarSystemLevel_2
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static void enable_c2_RadarSystemLevel_2(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static void disable_c2_RadarSystemLevel_2(SFc2_RadarSystemLevel_2InstanceStruct *
  chartInstance);
static void c2_update_debugger_state_c2_RadarSystemLevel_2
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_RadarSystemLevel_2
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static void set_sim_state_c2_RadarSystemLevel_2
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_RadarSystemLevel_2(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static void sf_c2_RadarSystemLevel_2(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static void initSimStructsc2_RadarSystemLevel_2
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static void registerMessagesc2_RadarSystemLevel_2
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static creal_T c2_emlrt_marshallIn(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c2_y, const char_T *c2_identifier);
static creal_T c2_b_emlrt_marshallIn(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_eml_scalar_eg(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static c2_coder_internal_cell_6 c2_cell_cell
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static void c2_iscellstr(SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static void c2_isconstcell(SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
...
static void c2_c_SystemProp_matlabCodegenSetAnyProp
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance,
   c2_phased_LinearFMWaveform *c2_obj);
static void c2_pvParse(SFc2_RadarSystemLevel_2InstanceStruct *chartInstance,
  c2_phased_LinearFMWaveform *c2_obj);
static creal_T c2_SystemCore_step(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance, c2_phased_LinearFMWaveform *c2_obj);
static boolean_T c2_any(SFc2_RadarSystemLevel_2InstanceStruct *chartInstance,
  boolean_T c2_x);
static void c2_AbstractPulseWaveform_setupImpl
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance,
   c2_phased_LinearFMWaveform *c2_obj);
static void c2_d_SystemProp_matlabCodegenSetAnyProp
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance,
   c2_phased_LinearFMWaveform *c2_obj);
static void c2_e_SystemProp_matlabCodegenSetAnyProp
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance,
   c2_phased_LinearFMWaveform *c2_obj);
static void c2_f_SystemProp_matlabCodegenSetAnyProp
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance,
   c2_phased_LinearFMWaveform *c2_obj);
static void c2_b_iscellstr(SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static void c2_b_isconstcell(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static void c2_val2ind(SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static void c2_validateattributes(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static void c2_b_validateattributes(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static void c2_c_validateattributes(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance);
static void c2_g_SystemProp_matlabCodegenSetAnyProp
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance,
   c2_phased_LinearFMWaveform *c2_obj);
static void c2_LinearFMWaveform_calcDistinctPulseParameters
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance,
   c2_phased_LinearFMWaveform *c2_obj);
static void c2_realmax(SFc2_RadarSystemLevel_2InstanceStruct *chartInstance);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_RadarSystemLevel_2, const
  char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_RadarSystemLevel_2InstanceStruct
  *chartInstance);
  ...
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_RadarSystemLevel_2 = 0U;
}
  ...
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_RadarSystemLevel_2;
  ...
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_y = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)),
    "y");
  chartInstance->c2_is_active_c2_RadarSystemLevel_2 = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_RadarSystemLevel_2");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_RadarSystemLevel_2(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_RadarSystemLevel_2MachineNumber_,
  ...
  c2_chartNumber)
{
  _SFD_SCRIPT_TRANSLATION(c2_chartNumber, 0U, sf_debug_get_script_id(
    "C:/Work/Demos/multidomainradar/waveform_lfm.m"));
}
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_RadarSystemLevel_2InstanceStruct *chartInstance;
  chartInstance = (SFc2_RadarSystemLevel_2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_RadarSystemLevel_2_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c2_m0, sf_mex_createstruct("nameCaptureInfo", 1, 147), FALSE);
  for (c2_i0 = 0; c2_i0 < 147; c2_i0++) {
    c2_r0 = &c2_info[c2_i0];
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[147])
{
  ...
  c2_info[0].resolved = "[E]C:/Work/Demos/multidomainradar/waveform_lfm.m";
  c2_info[0].fileTimeLo = 1361384493U;
  c2_info[0].fileTimeHi = 0U;
  c2_info[0].mFileTimeLo = 0U;
  c2_info[0].mFileTimeHi = 0U;
  c2_info[1].context = "[E]C:/Work/Demos/multidomainradar/waveform_lfm.m";
  c2_info[1].name = "mrdivide";
  c2_info[1].dominantType = "double";
  c2_info[1].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  c2_info[1].fileTimeLo = 1357976748U;
  ...
  c2_info[2].fileTimeLo = 1346535588U;
  ...
  c2_info[15].fileTimeLo = 1303171406U;
  c2_info[15].fileTimeHi = 0U;
  c2_info[15].mFileTimeLo = 0U;
  c2_info[15].mFileTimeHi = 0U;
  c2_info[16].context =
    "[IXC]$matlabroot$/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p";
  c2_info[16].name = "matlab.system.pvParse";
  c2_info[16].dominantType = "phased.LinearFMWaveform";
  c2_info[16].resolved =
    "[IXE]$matlabroot$/toolbox/matlab/system/+matlab/+system/pvParse.p";
  c2_info[16].fileTimeLo = 1357965980U;
  c2_info[16].fileTimeHi = 0U;
  c2_info[16].mFileTimeLo = 0U;
  c2_info[16].mFileTimeHi = 0U;
  c2_info[17].context =
    "[IXE]$matlabroot$/toolbox/matlab/system/+matlab/+system/pvParse.p";
  c2_info[17].name = "length";
  c2_info[17].dominantType = "cell";
  c2_info[17].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c2_info[17].fileTimeLo = 1303171406U;
  ...
  c2_info[18].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  c2_info[18].fileTimeLo = 1343855584U;
  ...
  c2_info[25].name = "isfinite";
  c2_info[25].dominantType = "double";
  c2_info[25].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c2_info[25].fileTimeLo = 1286843958U;
  ...
  c2_info[34].fileTimeLo = 1286843894U;
  ...
  c2_info[35].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c2_info[35].fileTimeLo = 1286843960U;
  ...
  c2_info[36].fileTimeLo = 1289544892U;
  ...
  c2_info[37].fileTimeLo = 1323195778U;
  ...
  c2_info[38].fileTimeLo = 1311280516U;
  ...
  c2_info[46].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c2_info[46].fileTimeLo = 1286843960U;
  ...
  c2_info[47].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/rem.m";
  c2_info[47].fileTimeLo = 1343855584U;
  ...
  c2_info[55].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/any.m";
  c2_info[55].fileTimeLo = 1286844034U;
  c2_info[55].fileTimeHi = 0U;
  c2_info[55].mFileTimeLo = 0U;
  c2_info[55].mFileTimeHi = 0U;
  c2_info[56].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c2_info[56].name = "eml_const_nonsingleton_dim";
  c2_info[56].dominantType = "logical";
  c2_info[56].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_const_nonsingleton_dim.m";
  c2_info[56].fileTimeLo = 1286843896U;
  c2_info[56].fileTimeHi = 0U;
  c2_info[56].mFileTimeLo = 0U;
  c2_info[56].mFileTimeHi = 0U;
  c2_info[57].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c2_info[57].name = "isnan";
  c2_info[57].dominantType = "logical";
  c2_info[57].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c2_info[57].fileTimeLo = 1286843960U;
...
static void c2_b_info_helper(c2_ResolvedFunctionInfo c2_info[147])
{
  c2_info[64].context =
    "[IXC]$matlabroot$/toolbox/phased/phased/+phased/+internal/AbstractContinuousPhasePulseWaveform.m";
  c2_info[64].name = "mrdivide";
  c2_info[64].dominantType = "double";
  c2_info[64].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  c2_info[64].fileTimeLo = 1357976748U;
  c2_info[64].fileTimeHi = 0U;
  c2_info[64].mFileTimeLo = 1319755166U;
  c2_info[64].mFileTimeHi = 0U;
  c2_info[65].context =
    "[IXC]$matlabroot$/toolbox/phased/phased/+phased/+internal/AbstractContinuousPhasePulseWaveform.m";
  c2_info[65].name = "sprintf";
  c2_info[65].dominantType = "char";
  c2_info[65].resolved = "[IXMB]$matlabroot$/toolbox/matlab/strfun/sprintf";
  c2_info[65].fileTimeLo = MAX_uint32_T;
  c2_info[65].fileTimeHi = MAX_uint32_T;
  c2_info[65].mFileTimeLo = MAX_uint32_T;
  c2_info[65].mFileTimeHi = MAX_uint32_T;
  c2_info[66].context =
    "[IXC]$matlabroot$/toolbox/phased/phased/+phased/+internal/AbstractContinuousPhasePulseWaveform.m";
  c2_info[66].name = "coder.internal.errorIf";
  c2_info[66].dominantType = "char";
  c2_info[66].resolved =
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/errorIf.m";
  c2_info[66].fileTimeLo = 1334097138U;
  c2_info[66].fileTimeHi = 0U;
  c2_info[66].mFileTimeLo = 0U;
  c2_info[66].mFileTimeHi = 0U;
  c2_info[67].context =
    "[IXC]$matlabroot$/toolbox/phased/phased/+phased/+internal/AbstractPulseWaveform.m";
  c2_info[67].name = "rdivide";
  c2_info[67].dominantType = "double";
  c2_info[67].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[67].fileTimeLo = 1346535588U;
  c2_info[67].fileTimeHi = 0U;
  c2_info[67].mFileTimeLo = 0U;
  c2_info[67].mFileTimeHi = 0U;
  c2_info[68].context =
    "[IXC]$matlabroot$/toolbox/phased/phased/+phased/+internal/AbstractPulseWaveform.m";
  c2_info[68].name = "round";
  c2_info[68].dominantType = "double";
  c2_info[68].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/round.m";
  c2_info[68].fileTimeLo = 1343855584U;
  c2_info[68].fileTimeHi = 0U;
  c2_info[68].mFileTimeLo = 0U;
  c2_info[68].mFileTimeHi = 0U;
  c2_info[69].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/round.m";
  c2_info[69].name = "eml_scalar_round";
  c2_info[69].dominantType = "double";
  c2_info[69].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_round.m";
  c2_info[69].fileTimeLo = 1307676438U;
  ...
  c2_info[70].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  c2_info[70].fileTimeLo = 1357976748U;
  c2_info[70].fileTimeHi = 0U;
  c2_info[70].mFileTimeLo = 1319755166U;
  c2_info[70].mFileTimeHi = 0U;
  c2_info[71].context =
    "[IXC]$matlabroot$/toolbox/phased/phased/+phased/+internal/AbstractPulseWaveform.m";
  c2_info[71].name = "val2ind";
  c2_info[71].dominantType = "double";
  c2_info[71].resolved = "[IXE]$matlabroot$/toolbox/phased/phased/val2ind.m";
  c2_info[71].fileTimeLo = 1332459528U;
  c2_info[71].fileTimeHi = 0U;
  c2_info[71].mFileTimeLo = 0U;
  c2_info[71].mFileTimeHi = 0U;
  c2_info[72].context = "[IXE]$matlabroot$/toolbox/phased/phased/val2ind.m";
  c2_info[72].name = "phased.internal.narginchk";
  c2_info[72].dominantType = "double";
  c2_info[72].resolved =
    "[IXE]$matlabroot$/toolbox/phased/phased/+phased/+internal/narginchk.m";
  c2_info[72].fileTimeLo = 1326736286U;
  c2_info[72].fileTimeHi = 0U;
  c2_info[72].mFileTimeLo = 0U;
  c2_info[72].mFileTimeHi = 0U;
  c2_info[73].context =
    "[IXE]$matlabroot$/toolbox/phased/phased/+phased/+internal/narginchk.m";
  c2_info[73].name = "coder.internal.assert";
  c2_info[73].dominantType = "char";
  c2_info[73].resolved =
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assert.m";
  c2_info[73].fileTimeLo = 1334097138U;
  ...
  c2_info[74].name = "coder.internal.cell";
  c2_info[74].dominantType = "char";
  c2_info[74].resolved =
    "[IXC]$matlabroot$/toolbox/coder/coder/+coder/+internal/cell.p";
  c2_info[74].fileTimeLo = 1357976772U;
  c2_info[74].fileTimeHi = 0U;
  c2_info[74].mFileTimeLo = 0U;
  c2_info[74].mFileTimeHi = 0U;
  c2_info[75].context = "[IXE]$matlabroot$/toolbox/phased/phased/val2ind.m";
  c2_info[75].name = "validateattributes";
  c2_info[75].dominantType = "coder.internal.cell";
  c2_info[75].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/validateattributes.m";
  c2_info[75].fileTimeLo = 1352450062U;
  ...
  c2_info[76].name = "isnan";
  c2_info[76].dominantType = "double";
  c2_info[76].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c2_info[76].fileTimeLo = 1286843960U;
  ...
  c2_info[77].name = "any";
  c2_info[77].dominantType = "logical";
  c2_info[77].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/any.m";
  c2_info[77].fileTimeLo = 1286844034U;
  ...
  c2_info[78].name = "sprintf";
  c2_info[78].dominantType = "char";
  c2_info[78].resolved = "[IXMB]$matlabroot$/toolbox/matlab/strfun/sprintf";
  c2_info[78].fileTimeLo = MAX_uint32_T;
  c2_info[78].fileTimeHi = MAX_uint32_T;
  c2_info[78].mFileTimeLo = MAX_uint32_T;
  c2_info[78].mFileTimeHi = MAX_uint32_T;
  c2_info[79].context = "[IXE]$matlabroot$/toolbox/phased/phased/val2ind.m";
  c2_info[79].name = "coder.internal.errorIf";
  c2_info[79].dominantType = "char";
  c2_info[79].resolved =
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/errorIf.m";
  c2_info[79].fileTimeLo = 1334097138U;
  ...
  c2_info[91].fileTimeLo = 1343855566U;
  c2_info[91].fileTimeHi = 0U;
  c2_info[91].mFileTimeLo = 0U;
  c2_info[91].mFileTimeHi = 0U;
  c2_info[92].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[92].name = "isfinite";
  c2_info[92].dominantType = "double";
  c2_info[92].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c2_info[92].fileTimeLo = 1286843958U;
  ...
  c2_info[93].name = "mtimes";
  c2_info[93].dominantType = "double";
  c2_info[93].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[93].fileTimeLo = 1289544892U;
  c2_info[93].fileTimeHi = 0U;
  c2_info[93].mFileTimeLo = 0U;
  c2_info[93].mFileTimeHi = 0U;
  c2_info[94].context = "[IXE]$matlabroot$/toolbox/phased/phased/val2ind.m";
  c2_info[94].name = "find";
  c2_info[94].dominantType = "logical";
  c2_info[94].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/find.m";
  c2_info[94].fileTimeLo = 1303171406U;
  ...
  c2_info[95].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c2_info[95].fileTimeLo = 1323195778U;
  ...
  c2_info[116].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[116].fileTimeLo = 1289544892U;
...
static void c2_c_info_helper(c2_ResolvedFunctionInfo c2_info[147])
{
  ...
  c2_info[145].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[145].fileTimeLo = 1289544892U;
  c2_info[145].fileTimeHi = 0U;
  c2_info[145].mFileTimeLo = 0U;
  c2_info[145].mFileTimeHi = 0U;
  c2_info[146].context =
    "[IXC]$matlabroot$/toolbox/phased/phased/+phased/+internal/AbstractPulseWaveform.m";
  c2_info[146].name = "find";
  c2_info[146].dominantType = "logical";
  c2_info[146].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/find.m";
  c2_info[146].fileTimeLo = 1303171406U;
  ...
  *chartInstance, c2_phased_LinearFMWaveform *c2_obj)
{
  ...
  if (!c2_obj->isInitialized) {
    ...
    for (c2_i5 = 0; c2_i5 < 36; c2_i5++) {
      c2_f_u[c2_i5] = c2_cv4[c2_i5];
    }

    c2_f_y = NULL;
    sf_mex_assign(&c2_f_y, sf_mex_create("y", c2_f_u, 10, 0U, 1U, 0U, 2, 1, 36),
                  FALSE);
    for (c2_i6 = 0; c2_i6 < 10; c2_i6++) {
      c2_g_u[c2_i6] = c2_cv5[c2_i6];
    }

    c2_g_y = NULL;
    sf_mex_assign(&c2_g_y, sf_mex_create("y", c2_g_u, 10, 0U, 1U, 0U, 2, 1, 10),
                  FALSE);
    for (c2_i7 = 0; c2_i7 < 5; c2_i7++) {
      c2_h_u[c2_i7] = c2_cv6[c2_i7];
    }

    c2_h_y = NULL;
    sf_mex_assign(&c2_h_y, sf_mex_create("y", c2_h_u, 10, 0U, 1U, 0U, 2, 1, 5),
                  FALSE);
    c2_i_u = 3.3333333333333335E-5;
    c2_i_y = NULL;
    sf_mex_assign(&c2_i_y, sf_mex_create("y", &c2_i_u, 0, 0U, 0U, 0U, 0), FALSE);
    sf_mex_call_debug("coder.internal.errorIf", 0U, 4U, 14, c2_e_y, 14, c2_f_y,
                      14, c2_g_y, 14, sf_mex_call_debug("sprintf", 1U, 2U, 14,
      c2_h_y, 14, c2_i_y));
    c2_AbstractPulseWaveform_setupImpl(chartInstance, c2_b_obj);
    c2_d_obj = c2_b_obj;
    c2_e_obj = c2_d_obj;
    c2_e_obj->pOutputStartSampleIndex = 1.0;
    c2_realmax(chartInstance);
    c2_f_obj = c2_d_obj;
    for (c2_i8 = 0; c2_i8 < 2; c2_i8++) {
      c2_f_obj->pOutputSampleInterval[c2_i8] = (real_T)c2_i8;
    }

    c2_g_obj = c2_b_obj;
    c2_g_obj->TunablePropsChanged = FALSE;
  }

  c2_h_obj = c2_obj;
  if (c2_h_obj->TunablePropsChanged) {
    c2_any(chartInstance, FALSE);
    c2_j_u = FALSE;
    c2_j_y = NULL;
    sf_mex_assign(&c2_j_y, sf_mex_create("y", &c2_j_u, 11, 0U, 0U, 0U, 0), FALSE);
    for (c2_i9 = 0; c2_i9 < 36; c2_i9++) {
      c2_k_u[c2_i9] = c2_cv4[c2_i9];
    }

    c2_k_y = NULL;
    sf_mex_assign(&c2_k_y, sf_mex_create("y", c2_k_u, 10, 0U, 1U, 0U, 2, 1, 36),
                  FALSE);
    for (c2_i10 = 0; c2_i10 < 10; c2_i10++) {
      c2_l_u[c2_i10] = c2_cv5[c2_i10];
    }

    c2_l_y = NULL;
    sf_mex_assign(&c2_l_y, sf_mex_create("y", c2_l_u, 10, 0U, 1U, 0U, 2, 1, 10),
                  FALSE);
    for (c2_i11 = 0; c2_i11 < 5; c2_i11++) {
      c2_m_u[c2_i11] = c2_cv6[c2_i11];
    }

    c2_m_y = NULL;
    sf_mex_assign(&c2_m_y, sf_mex_create("y", c2_m_u, 10, 0U, 1U, 0U, 2, 1, 5),
                  FALSE);
    c2_n_u = 3.3333333333333335E-5;
    c2_n_y = NULL;
    sf_mex_assign(&c2_n_y, sf_mex_create("y", &c2_n_u, 0, 0U, 0U, 0U, 0), FALSE);
    sf_mex_call_debug("coder.internal.errorIf", 0U, 4U, 14, c2_j_y, 14, c2_k_y,
                      14, c2_l_y, 14, sf_mex_call_debug("sprintf", 1U, 2U, 14,
      c2_m_y, 14, c2_n_y));
    c2_i_obj = c2_h_obj;
    c2_i_obj->TunablePropsChanged = FALSE;
  }

  c2_j_obj = c2_obj;
  for (c2_i12 = 0; c2_i12 < 2; c2_i12++) {
    c2_OutputSampleIndex[c2_i12] = c2_j_obj->pOutputStartSampleIndex +
      c2_j_obj->pOutputSampleInterval[c2_i12];
  }

  for (c2_i13 = 0; c2_i13 < 2; c2_i13++) {
    c2_OutputSampleIndex[c2_i13]--;
  }
  ...
  for (c2_i14 = 0; c2_i14 < 2; c2_i14++) {
    c2_OutputSampleIndex[c2_i14] = c2_b_r[c2_i14] + 1.0;
  }

  c2_k_obj = c2_j_obj;
  c2_value = c2_OutputSampleIndex[1];
  c2_k_obj->pOutputStartSampleIndex = c2_value;
  c2_varargout_1 = c2_dc1;
  ...
  for (c2_i15 = 0; c2_i15 <= c2_loop_ub; c2_i15++) {
    c2_currentPulseIdx_data[c2_i15] = (real_T)c2_ii_data[c2_i15];
  }
  ...
  if (!(c2_b2 || c2_b3)) {
    for (c2_i16 = 0; c2_i16 < 2; c2_i16++) {
      c2_iv0[c2_i16] = 1 + c2_i16;
    }

    _SFD_MATRIX_MATRIX_INDEX_CHECK(c2_iv0, 2, c2_currentPulseIdx_sizes, 2);
    ...
    for (c2_i17 = 0; c2_i17 <= c2_b_loop_ub; c2_i17++) {
      c2_sampleIdx_data[c2_i17] = (c2_OutputSampleIndex[(int32_T)
        c2_currentPulseIdx_data[c2_i17] - 1] - 1.0) + 1.0;
    }
    ...
    for (c2_i18 = 0; c2_i18 <= c2_c_loop_ub; c2_i18++) {
      c2_ii_data[c2_i18] = (int32_T)c2_currentPulseIdx_data[c2_i18];
    }
    ...
    for (c2_i19 = 0; c2_i19 <= c2_d_loop_ub; c2_i19++) {
      c2_currentPulseIdx_data[c2_i19] = (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("",
        (int32_T)_SFD_INTEGER_CHECK("", c2_sampleIdx_data[c2_i19]), 1, 40, 1, 0);
    }
    ...
    for (c2_i20 = 0; c2_i20 <= c2_e_loop_ub; c2_i20++) {
      c2_tmp_data[c2_i20] = c2_dcv0[(int32_T)c2_currentPulseIdx_data[c2_i20] - 1];
    }

    _SFD_SIZE_EQ_CHECK_1D(c2_ii_sizes[0] * c2_ii_sizes[1], c2_tmp_sizes);
    c2_dcv1[0] = c2_varargout_1;
    c2_f_loop_ub = c2_ii_sizes[0] * c2_ii_sizes[1] - 1;
    for (c2_i21 = 0; c2_i21 <= c2_f_loop_ub; c2_i21++) {
      c2_dcv1[c2_ii_data[c2_i21] - 1] = c2_tmp_data[c2_i21];
    }

    c2_varargout_1 = c2_dcv1[0];
  }

  return c2_varargout_1;
}
...
static void c2_AbstractPulseWaveform_setupImpl
  (SFc2_RadarSystemLevel_2InstanceStruct *chartInstance,
   c2_phased_LinearFMWaveform *c2_obj)
{
  c2_d_SystemProp_matlabCodegenSetAnyProp(chartInstance, c2_obj);
  c2_e_SystemProp_matlabCodegenSetAnyProp(chartInstance, c2_obj);
  c2_f_SystemProp_matlabCodegenSetAnyProp(chartInstance, c2_obj);
  c2_val2ind(chartInstance);
  c2_g_SystemProp_matlabCodegenSetAnyProp(chartInstance, c2_obj);
  c2_LinearFMWaveform_calcDistinctPulseParameters(chartInstance, c2_obj);
  c2_val2ind(chartInstance);
  c2_realmax(chartInstance);
}
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_RadarSystemLevel_2), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_RadarSystemLevel_2);
  return c2_y;
}
...
void sf_c2_RadarSystemLevel_2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_RadarSystemLevel_2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("0SNwZ4NVpzOq0T3cFH3U4G");
...
mxArray *sf_c2_RadarSystemLevel_2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_RadarSystemLevel_2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_RadarSystemLevel_2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_RadarSystemLevel_2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_RadarSystemLevel_2InstanceStruct *chartInstance;
    chartInstance = (SFc2_RadarSystemLevel_2InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _RadarSystemLevel_2MachineNumber_,
           2,
           1,
           1,
           1,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_RadarSystemLevel_2MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_RadarSystemLevel_2MachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _RadarSystemLevel_2MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c2_RadarSystemLevel_2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_RadarSystemLevel_2((SFc2_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
  initialize_c2_RadarSystemLevel_2((SFc2_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_RadarSystemLevel_2(void *chartInstanceVar)
{
  enable_c2_RadarSystemLevel_2((SFc2_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_RadarSystemLevel_2(void *chartInstanceVar)
{
  disable_c2_RadarSystemLevel_2((SFc2_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_RadarSystemLevel_2(void *chartInstanceVar)
{
  sf_c2_RadarSystemLevel_2((SFc2_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_RadarSystemLevel_2(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_RadarSystemLevel_2
    ((SFc2_RadarSystemLevel_2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_RadarSystemLevel_2();/* state var info */
...
extern void sf_internal_set_sim_state_c2_RadarSystemLevel_2(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_RadarSystemLevel_2((SFc2_RadarSystemLevel_2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_RadarSystemLevel_2(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_RadarSystemLevel_2(S);
}

static void sf_opaque_set_sim_state_c2_RadarSystemLevel_2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_RadarSystemLevel_2(S, st);
}

static void sf_opaque_terminate_c2_RadarSystemLevel_2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_RadarSystemLevel_2InstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_RadarSystemLevel_2_optimization_info();
    }

    finalize_c2_RadarSystemLevel_2((SFc2_RadarSystemLevel_2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_RadarSystemLevel_2((SFc2_RadarSystemLevel_2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_RadarSystemLevel_2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_RadarSystemLevel_2
      ((SFc2_RadarSystemLevel_2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_RadarSystemLevel_2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_RadarSystemLevel_2_optimization_info();
  ...
  ssSetChecksum0(S,(2967639754U));
  ssSetChecksum1(S,(2761075810U));
  ssSetChecksum2(S,(4062260323U));
  ssSetChecksum3(S,(109839221U));
...
static void mdlRTW_c2_RadarSystemLevel_2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_RadarSystemLevel_2(SimStruct *S)
{
  SFc2_RadarSystemLevel_2InstanceStruct *chartInstance;
  chartInstance = (SFc2_RadarSystemLevel_2InstanceStruct *)utMalloc(sizeof
    (SFc2_RadarSystemLevel_2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_RadarSystemLevel_2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_RadarSystemLevel_2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_RadarSystemLevel_2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_RadarSystemLevel_2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_RadarSystemLevel_2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_RadarSystemLevel_2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_RadarSystemLevel_2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_RadarSystemLevel_2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_RadarSystemLevel_2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_RadarSystemLevel_2;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_RadarSystemLevel_2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_RadarSystemLevel_2;
...
void c2_RadarSystemLevel_2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_RadarSystemLevel_2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_RadarSystemLevel_2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_RadarSystemLevel_2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_RadarSystemLevel_2_method_dispatcher.\n"
