...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_RadarSystemLevel_lfm_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_RadarSystemLevel_lfm_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_RadarSystemLevel_lfm_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "RadarSystemLevel_lfm") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_RadarSystemLevel_lfm_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_RadarSystemLevel_lfm_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "RadarSystemLevel_lfm") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_RadarSystemLevel_lfm_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_RadarSystemLevel_lfm_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"RadarSystemLevel_lfm")) {
    return(sf_RadarSystemLevel_lfm_method_dispatcher(simstructPtr,
...
extern void RadarSystemLevel_lfm_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    RadarSystemLevel_lfm_terminator();
    sf_debug_terminate();
  }
...
extern void RadarSystemLevel_lfm_initializer(void);
extern void RadarSystemLevel_lfm_register_exported_symbols(SimStruct* S);
extern void RadarSystemLevel_lfm_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  RadarSystemLevel_lfm_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      RadarSystemLevel_lfm_debug_initialize();
    }

    RadarSystemLevel_lfm_initializer();
  }
