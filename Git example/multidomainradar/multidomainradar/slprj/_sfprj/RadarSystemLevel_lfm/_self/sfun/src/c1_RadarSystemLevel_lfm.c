...
static void initialize_c1_RadarSystemLevel_lfm
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance);
static void initialize_params_c1_RadarSystemLevel_lfm
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance);
static void enable_c1_RadarSystemLevel_lfm
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance);
static void disable_c1_RadarSystemLevel_lfm
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_RadarSystemLevel_lfm
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_RadarSystemLevel_lfm
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance);
static void set_sim_state_c1_RadarSystemLevel_lfm
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_RadarSystemLevel_lfm
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance);
static void sf_c1_RadarSystemLevel_lfm(SFc1_RadarSystemLevel_lfmInstanceStruct
  *chartInstance);
static void initSimStructsc1_RadarSystemLevel_lfm
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static creal_T c1_emlrt_marshallIn(SFc1_RadarSystemLevel_lfmInstanceStruct
  *chartInstance, const mxArray *c1_y, const char_T *c1_identifier);
static creal_T c1_b_emlrt_marshallIn(SFc1_RadarSystemLevel_lfmInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_RadarSystemLevel_lfmInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_RadarSystemLevel_lfmInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_RadarSystemLevel_lfmInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_RadarSystemLevel_lfm, const
  char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_RadarSystemLevel_lfmInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_RadarSystemLevel_lfmInstanceStruct
  *chartInstance);
  ...
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_RadarSystemLevel_lfm = 0U;
}
  ...
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_RadarSystemLevel_lfm;
  ...
  (SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_y = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
    "y");
  chartInstance->c1_is_active_c1_RadarSystemLevel_lfm = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_RadarSystemLevel_lfm");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_RadarSystemLevel_lfm(chartInstance);
  ...
  *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_b_Doppler, 3U,
    c1_b_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_Ts, 4U, c1_b_sf_marshallOut);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance;
  chartInstance = (SFc1_RadarSystemLevel_lfmInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_RadarSystemLevel_lfm_get_eml_resolved_functions_info(void)
{
...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[32])
{
  ...
  c1_info[4].fileTimeLo = 1286843960U;
  c1_info[4].fileTimeHi = 0U;
  c1_info[4].mFileTimeLo = 0U;
  c1_info[4].mFileTimeHi = 0U;
  c1_info[5].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c1_info[5].name = "isnan";
  ...
  c1_info[8].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c1_info[8].fileTimeLo = 1286843894U;
  ...
  c1_info[9].fileTimeLo = 1286843912U;
  ...
  c1_info[22].fileTimeLo = 1289544892U;
  ...
  c1_info[23].name = "mrdivide";
  c1_info[23].dominantType = "double";
  c1_info[23].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  c1_info[23].fileTimeLo = 1342836144U;
  c1_info[23].fileTimeHi = 0U;
  c1_info[23].mFileTimeLo = 1319755166U;
  ...
  c1_info[24].fileTimeLo = 1286844044U;
  ...
  c1_info[25].fileTimeLo = 1313373010U;
  ...
  c1_info[26].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c1_info[26].fileTimeLo = 1286843942U;
  ...
  c1_info[27].fileTimeLo = 1323195778U;
  ...
  c1_info[28].fileTimeLo = 1311280516U;
  ...
  c1_info[29].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/exp.m";
  c1_info[29].fileTimeLo = 1286843940U;
  c1_info[29].fileTimeHi = 0U;
  c1_info[29].mFileTimeLo = 0U;
  c1_info[29].mFileTimeHi = 0U;
  c1_info[30].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/exp.m";
  c1_info[30].name = "eml_scalar_exp";
  c1_info[30].dominantType = "double";
  c1_info[30].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_exp.m";
  c1_info[30].fileTimeLo = 1301353664U;
  c1_info[30].fileTimeHi = 0U;
  c1_info[30].mFileTimeLo = 0U;
  c1_info[30].mFileTimeHi = 0U;
  c1_info[31].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_exp.m";
  c1_info[31].name = "mrdivide";
  c1_info[31].dominantType = "double";
  c1_info[31].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  c1_info[31].fileTimeLo = 1342836144U;
  c1_info[31].fileTimeHi = 0U;
  c1_info[31].mFileTimeLo = 1319755166U;
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_RadarSystemLevel_lfm), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_RadarSystemLevel_lfm);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_RadarSystemLevel_lfm_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_RadarSystemLevel_lfm_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VQFkPhWRD2RdiQvgHpxLLB");
...
static const mxArray *sf_get_sim_state_info_c1_RadarSystemLevel_lfm(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_RadarSystemLevel_lfm\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_RadarSystemLevel_lfm_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance;
    chartInstance = (SFc1_RadarSystemLevel_lfmInstanceStruct *)
...
static void sf_opaque_initialize_c1_RadarSystemLevel_lfm(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_RadarSystemLevel_lfmInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_RadarSystemLevel_lfm
    ((SFc1_RadarSystemLevel_lfmInstanceStruct*) chartInstanceVar);
  initialize_c1_RadarSystemLevel_lfm((SFc1_RadarSystemLevel_lfmInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_RadarSystemLevel_lfm(void *chartInstanceVar)
{
  enable_c1_RadarSystemLevel_lfm((SFc1_RadarSystemLevel_lfmInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_RadarSystemLevel_lfm(void *chartInstanceVar)
{
  disable_c1_RadarSystemLevel_lfm((SFc1_RadarSystemLevel_lfmInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_RadarSystemLevel_lfm(void *chartInstanceVar)
{
  sf_c1_RadarSystemLevel_lfm((SFc1_RadarSystemLevel_lfmInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_RadarSystemLevel_lfm
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_RadarSystemLevel_lfm
    ((SFc1_RadarSystemLevel_lfmInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_RadarSystemLevel_lfm();/* state var info */
...
extern void sf_internal_set_sim_state_c1_RadarSystemLevel_lfm(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_RadarSystemLevel_lfm((SFc1_RadarSystemLevel_lfmInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_RadarSystemLevel_lfm(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c1_RadarSystemLevel_lfm(S);
}

static void sf_opaque_set_sim_state_c1_RadarSystemLevel_lfm(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_RadarSystemLevel_lfm(S, st);
}

static void sf_opaque_terminate_c1_RadarSystemLevel_lfm(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_RadarSystemLevel_lfmInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_RadarSystemLevel_lfm((SFc1_RadarSystemLevel_lfmInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_RadarSystemLevel_lfm((SFc1_RadarSystemLevel_lfmInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_RadarSystemLevel_lfm(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_RadarSystemLevel_lfm
      ((SFc1_RadarSystemLevel_lfmInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_RadarSystemLevel_lfm(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3612481955U));
  ssSetChecksum1(S,(2985146751U));
  ssSetChecksum2(S,(3852429984U));
  ssSetChecksum3(S,(1109079882U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_RadarSystemLevel_lfm(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_RadarSystemLevel_lfm(SimStruct *S)
{
  SFc1_RadarSystemLevel_lfmInstanceStruct *chartInstance;
  chartInstance = (SFc1_RadarSystemLevel_lfmInstanceStruct *)malloc(sizeof
    (SFc1_RadarSystemLevel_lfmInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_RadarSystemLevel_lfmInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_RadarSystemLevel_lfm;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_RadarSystemLevel_lfm;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_RadarSystemLevel_lfm;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_RadarSystemLevel_lfm;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_RadarSystemLevel_lfm;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_RadarSystemLevel_lfm;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_RadarSystemLevel_lfm;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_RadarSystemLevel_lfm;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_RadarSystemLevel_lfm;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_RadarSystemLevel_lfm;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_RadarSystemLevel_lfm;
...
void c1_RadarSystemLevel_lfm_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_RadarSystemLevel_lfm(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_RadarSystemLevel_lfm(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_RadarSystemLevel_lfm(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_RadarSystemLevel_lfm_method_dispatcher.\n"
